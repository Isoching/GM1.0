function gp = eCO2_VTU_SPCE(gp) %configuration
...
gp.userdata.xtrain = train_VTU_SPCE(:,1:3); 
gp.userdata.ytrain = train_VTU_SPCE(:,4); 
gp.userdata.xtest = test_VTU_SPCE(:,1:3); 
gp.userdata.ytest = test_VTU_SPCE(:,4); 
gp.userdata.name = 'eCO2R_VTU_SPCE';
