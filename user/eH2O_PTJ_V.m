function gp = eH2O_PTJ_V(gp) %configuration
...
gp.userdata.xtrain = train_PTJ_V(:,1:3); 
gp.userdata.ytrain = train_PTJ_V(:,4); 
gp.userdata.xtest = test_PTJ_V(:,1:3); 
gp.userdata.ytest = test_PTJ_V(:,4); 
gp.userdata.name = 'eH2OR_PTJ_V';
