# GMGPTIPS2F Toolbox for MATLAB #

GMGPTIPS2F is the updated evolution of the version of the MATLAB toolbox developed by Dr. Dominic Searson (GPTIPS2F). 

This data driven model for green methanol was developed by adapting and modestly modifying the baseline framework to suit the present case study. Two tasks were completed. First, surrogate models were constructed for the carbon dioxide electrolyser and the water electrolyser to quantify the relationships between operating variables and observed responses. Second, at the overall system scale, techno economic and energy analyses were performed for the methanol production system.
